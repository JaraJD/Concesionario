...
namespace Mongo.DrivenAdapter
{
	public class Context :  IContext
	{
		...
		public IMongoCollection<MarcaEntitie> Autos => _database.GetCollection<MarcaEntitie>("autos");
		public IMongoCollection<MarcaEntitie> Concesionarios => _database.GetCollection<MarcaEntitie>("concesionarios");
	}
}
